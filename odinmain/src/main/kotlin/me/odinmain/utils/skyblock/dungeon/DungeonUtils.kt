...
object DungeonUtils {
    ...
    inline val score: Int get() = getScore()
    ...
    fun getScore(): Int {
        val exploration = (min(40, floor((secretCount / neededSecretsAmount * 40f))).toInt()) + (min(60, floor((completedRoomCount/totalRooms * 60).toDouble())).toInt())
