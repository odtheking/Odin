...
object RoundedRectangleTesting : Module(
    ...
    private val color2: Color by OldColorSetting("Color 2", Color.WHITE, true)
    private val dir: Int by NumberSetting("Gradient Direction", 0, 0, 3)
    private val borderColor: Color by OldColorSetting("Border Color", Color.GRAY, true)
    private val shadowColor: Color by OldColorSetting("Shadow Color", Color.DARK_GRAY, true)
