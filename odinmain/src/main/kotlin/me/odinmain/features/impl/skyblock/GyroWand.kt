...
object GyroWand : Module(
    ...
    private val color: Color by OldColorSetting("Color", Color.MAGENTA.withAlpha(0.5f), allowAlpha = true)
    ...
    private val cooldownColor: Color by OldColorSetting("Cooldown Color", Color.RED, allowAlpha = true).withDependency { showCooldown }
