...
import me.odinmain.features.impl.floor7.p3.termsim.isTermSimOpen
...
object MelodyMessage : Module(
    ...
    fun onGuiLoad(event: GuiEvent.GuiLoadedEvent) {
        if (!DungeonUtils.inDungeons || saidMelody || !event.name.startsWith("Click the button on time!") || isTermSimOpen()) return
    ...
    init {
        execute(50){
            ...
            if (isTermSimOpen()) return@execute
