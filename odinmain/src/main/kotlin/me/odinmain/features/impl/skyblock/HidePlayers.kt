...
object HidePlayers : Module(
    ...
    private val distance: Double by NumberSetting("distance", 3.0, 0.0, 32.0, .5, false, "The amount of clicks per second to perform.").withDependency { !hideAll }
    private val clickThrough: Boolean by BooleanSetting("Click Through", default = false, false, "Allows clicking through the entity").withDependency { !onLegitVersion }
