...
object PuzzleSolvers : Module(
    ...
    val tttColor: Color by OldColorSetting("TTT Color", Color.GREEN, true, description = "Color for the tic tac toe solver").withDependency { tttSolver && tttDropDown }
    ...
    val weirdosColor: Color by OldColorSetting("Weirdos Color", Color.GREEN, true, description = "Color for the weirdos solver").withDependency { weirdosSolver && weirdosDropDown }
