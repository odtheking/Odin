...
object Animations : Module(
    ...
    private val size: Float by NumberSetting("Size", 0.0f, -1.5, 1.5, 0.05, description = "Scales the size of your currently held item. Default: 0")
    private val x: Float by NumberSetting("X", 0.0f, -2.5, 1.5, 0.05, description = "Moves the held item. Default: 0")
    private val y: Float by NumberSetting("Y", 0.0f, -1.5, 1.5, 0.05, description = "Moves the held item. Default: 0")
    private val z: Float by NumberSetting("Z", 0.0f, -1.5, 3.0, 0.05, description = "Moves the held item. Default: 0")
    private val yaw: Float by NumberSetting("Yaw", 0.0f, -180.0, 180.0, 5.0, description = "Rotates your held item. Default: 0")
    private val pitch: Float by NumberSetting("Pitch", 0.0f, -180.0, 180.0, 5.0, description = "Rotates your held item. Default: 0")
    private val roll: Float by NumberSetting("Roll", 0.0f, -180.0, 180.0, 5.0, description = "Rotates your held item. Default: 0")
