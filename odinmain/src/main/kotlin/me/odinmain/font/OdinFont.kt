...
class OdinFont(
    ...
    private fun getStringInformation(string: String, pointSize: Float): Pair<Float, Float> {
        var width = 0f
        var height = 0f
        var currentPointSize = pointSize * 1.362306f
...
//                    currentPointSize = pointSize * 1.1081f //Adjust bold being smaller
    ...
    override fun drawString(
        ...
        val effectiveSize = originalPointSize * scale * 1.362306f
...
//        }
    ...
    companion object {
        ...
        fun initShaders() {
            ...
            shader = UShader.fromLegacyShader(this.readShader("font", "vsh"), readShader("font", "fsh"), BlendState.NORMAL)
            if (!shader.usable) {
