...
import me.odinmain.features.impl.render.OutlineItemEntity
...
object EntityOutlineRenderer {
    ...
    private val CustomRenderGlobal.shader get() = entityOutlineShader
     ...
     */
    @JvmStatic
    fun renderEntityOutlines(camera: ICamera, partialTicks: Float, vector: Vec3): Boolean {
    ...
    fun shouldRenderEntityOutlines(): Boolean {
        // SkyBlock Conditions
        //if (!LocationUtils.inSkyblock) return false
    ...
    private fun isEnabled(): Boolean {
        ...
        if (OutlineItemEntity.enabled) return true
    ...
    fun onTick(event: TickEvent.ClientTickEvent) {
        ...
        val renderGlobal = try {
            ...
            println("Unable to enable entity outlines, the required mixin is not loaded")
            isMissingMixin = true
            return
        }
