...
object HidePlayers : Module(
    ...
    private val hideAll by BooleanSetting("Hide all", default = false, "Hides all players, regardless of distance.")
    ...
    private val clickThrough by BooleanSetting("Click Through", default = false, "Allows clicking through players.")
    private val onlyDevs by BooleanSetting("only at Devs", default = false, "Only hides players when standing at ss or fourth device.")
