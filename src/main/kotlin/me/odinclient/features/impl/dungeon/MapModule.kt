...
object MapModule : Module(
    ...
    val nanoScanTime: Boolean by BooleanSetting("Nano Scan Time", false)
    ...
    val mapScale: Float by NumberSetting("Scale", 1f, 0.5f, 2f)
    val textScale: Float by NumberSetting("Text Scale", 1f, 0.5f, 2f)
    val playerHeadScale: Float by NumberSetting("Player Head Scale", 1f, 0.5f, 2f)
    val borderWidth: Double by NumberSetting("Border Width", 3.0, 0.0, 10.0)
