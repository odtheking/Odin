...
object DioriteFucker {
    ...
    private val glass = Blocks.glass.defaultState
    ...
    fun onTick(event: ClientTickEvent) {
        ...
        repeat(37) { height ->
            for (block in pillars) {
                val b = block.add(0, height, 0)
                if (WorldUtils.getBlockIdAt(b) == 1)
                    mc.theWorld.setBlockState(b, glass, 3)
            }
        }
    }
}