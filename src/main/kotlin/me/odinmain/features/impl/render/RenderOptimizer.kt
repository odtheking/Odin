...
object RenderOptimizer : Module(
    ...
    private val removeExplosion by BooleanSetting("Remove Explosion").withDependency { showParticleOptions }
    ...
    private val hideHeartParticles by BooleanSetting(name = "Hide Heart Particles", default = true, description = "Hides heart particles.").withDependency { showParticleOptions }
