...
import me.odinmain.features.impl.render.ClickGUI.gray38
...
object LeapMenu : Module(
    ...
    private val textColor by ColorSetting("Text Color", gray38, description = "Color for the text in the leap menu.")
...
//    fun leapMenu(teammates: Array<DungeonPlayer>) = Aurora(renderer = NVGRenderer) {
//
//
//    }
