...
object LeapMenu : Module(
    ...
    private val leapHelperColor by ColorSetting("Leap Helper Color", default = Color.WHITE, description = "Color of the Leap Helper highlight.").withDependency { leapHelperToggle }
