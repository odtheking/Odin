...
object DungeonWaypoints : Module(
    ...
    private var reachColor by ColorSetting("Reach Color", Color.RGB(0, 255, 213, 0.43f), description = "Color of the reach box highlight.", allowAlpha = true).withDependency { allowEdits }
