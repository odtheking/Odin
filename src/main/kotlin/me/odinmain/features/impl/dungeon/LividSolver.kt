...
object LividSolver : Module(
    ...
    private val showTracer by BooleanSetting("Show Tracer", false, description = "Shows a tracer to the highlighted Livid.")
    ...
    init {
        HighlightRenderer.addEntityGetter({ HighlightRenderer.HighlightType.entries[mode] }) {
            ...
            currentLivid.entity?.let { listOf(HighlightRenderer.HighlightEntity(it, currentLivid.color, thickness, OdinMain.isLegitVersion, style, showTracer)) } ?: emptyList()
        }
