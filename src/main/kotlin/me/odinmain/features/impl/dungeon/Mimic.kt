...
object Mimic : Module(
    ...
    private val range by NumberSetting("Range", 10f, 2f, 30f, 1f, desc = "The range at which princes will be detected.", unit = " Blocks").withDependency { princeDetection && princeMessageToggle }
