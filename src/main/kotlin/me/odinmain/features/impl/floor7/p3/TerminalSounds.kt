...
object TerminalSounds : Module(
    ...
    private val customSound by StringSetting(
        "Custom Click Sound", "mob.blaze.hit",
    ...
    private val reset by ActionSetting("Play click sound", desc = "Plays the sound with the current settings.") { PlayerUtils.playLoudSound(if (sound == defaultSounds.size - 1) customSound else defaultSounds[sound], clickVolume, clickPitch) }
