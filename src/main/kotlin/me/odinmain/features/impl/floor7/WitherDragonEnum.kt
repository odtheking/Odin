...
enum class WitherDragonsEnum (
    ...
    Red(Vec3(27.0, 14.0, 59.0), AxisAlignedBB(14.5, 13.0, 45.5, 39.5, 28.0, 70.5),'c', Color.MINECRAFT_RED,
    ...
    Green(Vec3(27.0, 14.0, 94.0), AxisAlignedBB(7.0,  8.0,  80.0, 37.0, 28.0, 110.0),'a', Color.MINECRAFT_GREEN,
        23.0..29.0, 91.0..97.0, skipKillTime = 2600),

    Blue(Vec3(84.0, 14.0, 94.0), AxisAlignedBB(71.5, 16.0, 82.5, 96.5, 26.0, 107.5),'b', Color.MINECRAFT_BLUE,
...
fun handleSpawnPacket(particle: S2APacketParticles) {
    ...
    val spawningDragons = WitherDragonsEnum.entries.filter { it.state == WitherDragonState.SPAWNING }.toMutableList()
