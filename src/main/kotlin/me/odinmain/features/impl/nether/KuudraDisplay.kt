...
object KuudraDisplay : Module(
    ...
    private val kuudraColor by ColorSetting("Kuudra Color", Colors.MINECRAFT_RED, true, description = "Color of the kuudra highlight.").withDependency { highlightKuudra }
