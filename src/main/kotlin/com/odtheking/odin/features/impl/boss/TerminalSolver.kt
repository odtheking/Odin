...
object TerminalSolver : Module(
    ...
    val customTermSize by NumberSetting("Term Size", 2f, .6f, 3f, 0.05f, desc = "The size of the custom terminal GUI.").withDependency { renderType == 2 }
    ...
    val adjustToGuiScale by BooleanSetting("Adjust Scale", true, "Adjusts terminal scale to max gui size.")
