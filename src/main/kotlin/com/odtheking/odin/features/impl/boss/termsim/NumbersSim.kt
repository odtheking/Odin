...
object NumbersSim : TermSimGUI(
    ...
    override fun create() {
        ...
        setSlots {
            if (floor(it.index / 9f) in 1f..2f && it.index % 9 in 2..6) ItemStack(Items.RED_STAINED_GLASS_PANE, used.first()).apply { set(DataComponents.CUSTOM_NAME, Component.literal("§a${used.removeFirst()}")) }
            else blackPane
        }
    }
    ...
    override fun slotClick(slot: Slot, button: Int) {
        ...
        slot.setSlot(ItemStack(Items.LIME_STAINED_GLASS_PANE, slot.item.count).apply { set(DataComponents.CUSTOM_NAME, Component.literal("")) })
