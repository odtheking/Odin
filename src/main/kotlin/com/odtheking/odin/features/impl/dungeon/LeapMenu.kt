...
object LeapMenu : Module(
    ...
    private val leapAnnounceMessageBegin by StringSetting("Leap Message Start", "Leaped to", 128, desc = "The start of the leap announce").withDependency { leapAnnounce }
