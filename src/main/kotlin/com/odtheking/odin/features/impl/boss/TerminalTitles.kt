...
object TerminalTitles : Module(
    ...
    private val selfOnly by BooleanSetting("Self Only", true, desc = "Only replace title messages when your own name appears.")
    ...
    private val customTitle by StringSetting(
        "Custom Title", "&a{name} &7{action} a {type}! (&c{current}&7/&a{total}&7)", 128,
