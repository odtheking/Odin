...
object PuzzleSolvers : Module(
    ...
    private val blazeStyle by SelectorSetting("Blaze Style", BoxStyle.OUTLINE, desc = "Whether or not the box should be filled.").withDependency { blazeSolver && blazeDropDown }
