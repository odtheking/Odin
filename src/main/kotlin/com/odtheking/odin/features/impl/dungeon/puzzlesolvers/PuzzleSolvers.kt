...
object PuzzleSolvers : Module(
    ...
    private val waterDropDown by DropdownSetting("Water Board", desc = "Shows settings for the water board puzzle solver.")
    ...
    private val mazeDropDown by DropdownSetting("TP Maze", desc = "Shows settings for the TP maze puzzle solver.")
    ...
    private val iceFillDropDown by DropdownSetting("Ice Fill", desc = "Shows settings for the ice fill puzzle solver.")
    ...
    private val blazeDropDown by DropdownSetting("Blaze", desc = "Shows settings for the Blaze puzzle solver.")
    ...
    private val blazeLineWidth by NumberSetting("Blaze Solver Lines Width", 2f, 0.5..5.0, 0.1, desc = "Width for blaze lines.").withDependency { blazeSolver && blazeDropDown }
    private val blazeStyle by SelectorSetting("Blaze Style", BoxStyle.FILLED_OUTLINE, desc = "Whether or not the box should be filled.").withDependency { blazeSolver && blazeDropDown }
    ...
    private val beamsDropDown by DropdownSetting("Creeper Beams", desc = "Shows settings for the Creeper Beams puzzle solver.")
    ...
    private val beamStyle by SelectorSetting("Beams Style", BoxStyle.FILLED_OUTLINE, desc = "Whether or not the box should be filled.").withDependency { beamsSolver && beamsDropDown }
    ...
    private val beamsAlpha by NumberSetting("Beams Color Alpha", .7f, 0.0..1.0, .05f, desc = "The alpha of the color.").withDependency { beamsSolver && beamsDropDown }
    ...
    private val weirdosDropDown by DropdownSetting("Three Weirdos", desc = "Shows settings for the Three Weirdos puzzle solver.")
    ...
    private val weirdosStyle by SelectorSetting("Weirdos Style", BoxStyle.FILLED_OUTLINE, desc = "Whether or not the box should be filled.").withDependency { weirdosSolver && weirdosDropDown }
    ...
    private val quizDropdown by DropdownSetting("Quiz", desc = "Shows settings for the trivia puzzle solver.")
    ...
    private val boulderDropDown by DropdownSetting("Boulder", desc = "Shows settings for the boulder puzzle solver.")
